...
*/
	public function getInfosGestionnaire($login, $mdp){
		$req = "select id, prenom,nom from gestionnaire
 ...
 * @return l'id, le nom et le prénom sous la forme d'un tableau associatif 
*/
	public function ajoutvisiteur( $id,$login,$mdp,$nom, $prenom,$cp,$ville,$DateEmbauche){
		$req = "INSERT INTO visiteur VALUES('$id','$login','$mdp','$nom', '$prenom','$cp','$ville','$DateEmbauche')";
